...
target_pos = [3, -8, 0.052, -pi/2; 9, 0, 0.052, -pi/4; 6, 6, 0.052, -pi/4;];
finish_pos = [5, -5, 0.052, -pi/2; 5, -5, 0.052+0.025, -pi/4; 5, -5, 0.052+0.05, -pi/4; ];
target_pos_rot = [9, 0, 0.052, -pi/2.2];
finish_pos_rot = [(9-0.22*sin(angle_off2)), (0-0.22*cos(angle_off2)), 0.052, 0];
